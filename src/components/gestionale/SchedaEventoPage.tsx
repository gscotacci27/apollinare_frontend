...
import {
  ArrowLeft, Loader2, Save, RotateCcw, Trash2, Plus, X,
} from 'lucide-react'
...
import type { OspiteItem, ExtraItem, AccontoItem, PreventivoCalc, SchedaResponse } from '@/types/gestionale'
...
const PreventivoCard = ({ prev }: { prev: PreventivoCalc }) => (
  <div className="mx-5 my-3 rounded-lg bg-slate-900 border border-slate-800 overflow-hidden shrink-0">
    <div className="grid grid-cols-6 divide-x divide-slate-800 text-center text-xs">
      {[
        ...
        { label: 'Totale', value: prev.totale_netto },
  ...
  return (
    <div className="flex flex-col h-full bg-slate-950">
      ...
      <div className="flex-1 overflow-y-auto py-3">
        {/* Preventivo */}
        <PreventivoCard prev={displayScheda.preventivo} />
